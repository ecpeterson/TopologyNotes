...
An \define{$H$--space} $K$ is a pointed space with maps $\mu$ and $\chi$ satisfying the group diagrams up to homotopy (i.e., as diagrams in $h\CatOf{Spaces}_{*/}$).
\end{definition}
...
\begin{definition}\marginnote{\citep[3.12--13 and 3.17]{Switzer}}
...
\begin{corollary}\marginnote{\citep[Corollary 4.8]{Switzer}}
...
\begin{example}[Grassmannians]\marginnote{\citep[Examples 4.14.2]{Switzer}}
...
\begin{example}\marginnote{\citep[Remarks 4.21.iv]{Switzer}}
