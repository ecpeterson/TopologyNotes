...
\todo{This is missing some $2$--localizations in the notation.}
...
\todo{Finish diff'ls and structlines.}
\marginnote{
We also include a picture of the fully specified EHP spectral sequence in this range.
\begin{sseqdata}[name = EHP, update existing]
\class[fill](5,2)
\class[fill](6,2)
\class[fill](4,3)
